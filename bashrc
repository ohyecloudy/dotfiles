...
if [[ "$MSYSTEM" == "MSYS" ]] || [[ "$MSYSTEM" == "MINGW"* ]]; then
    ...
    export PATH="/opt/homebrew/bin:$HOME/.local/bin:$HOME/bin.local:$HOME/bin:/usr/local/opt/python@3.8/libexec/bin:$HOME/developer/flutter/bin:$HOME/.emacs.d/bin:$PATH";
